...
# 	Tabula - for parsing data from degree map PDFs
# 		Originally modified to run with javaw instead of java (for no terminal pop-up) but no longer included
# 	pdf2image.convert_from_bytes - convert degree map PDF to image
# 	Poppler - PDF renderer for pdf2image (installed as poppler-22.04.0\Library\bin)
